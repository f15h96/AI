...
{
    /// <summary>
    /// It is a perception condition to check which tower type more prominent in the scene
    /// </summary>
    [Condition("Perception/SingleTowerCheck")]
    [Help("Checks which tower type more prominent in the scene")]
    public class SingleTowerCheck : ConditionBase
    {
        ...
        {
            if (TowerType.Equals("SingleTarget"))
            {
                return true;
            }
            else
